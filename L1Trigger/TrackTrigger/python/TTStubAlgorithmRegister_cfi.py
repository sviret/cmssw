...
#
# This script is adapted to the very last Tilted Tracker geometry to date (D11)
#
# 
...
TTStubAlgorithm_official_Phase2TrackerDigi_ = cms.ESProducer("TTStubAlgorithm_official_Phase2TrackerDigi_",
   ...
   BarrelCut = cms.vdouble( 0, 2., 2., 3, 4, 5, 6.5), #Use 0 as dummy to have direct access using DetId to the correct element 
