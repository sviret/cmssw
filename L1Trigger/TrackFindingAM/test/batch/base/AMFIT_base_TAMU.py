...
process.TTStubAssociatorFromPixelDigis.TTStubs        = cms.VInputTag( cms.InputTag("MergeFITOutputT", "StubInTrackT"))
...
process.TTTrackAssociatorFromPixelDigis.TTTracks      = cms.VInputTag( cms.InputTag("MergeFITOutputT", "AML1TracksT"))
...
process.MIBextraction.L1track_tag      = cms.InputTag( "MergeFITOutputT", "AML1TracksT")
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackNtupleMaker',
                                       ...
                                       L1TrackInputTag = cms.InputTag("MergeFITOutputT", "AML1TracksT"),               ## TTTrack input
                                       MCTruthTrackInputTag = cms.InputTag("TTTrackAssociatorFromPixelDigis", "AML1TracksT") ## MCTruth input 

                                       )

# Path and EndPath definitions
process.L1AMFIT_step         = cms.Path(process.TTTracksTFromTCswStubs)
