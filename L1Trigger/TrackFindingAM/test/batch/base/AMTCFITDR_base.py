...
process.TTTCsFromPattern.maxTCsperTower= cms.int32(60)

process.TTACBsFromPattern.maxRoadsperTower= cms.int32(250)
process.TTSCBsFromPattern.maxRoadsperTower= cms.int32(250)

process.TTACBsFromPattern.maxFitsperTower= cms.int32(1100)
process.TTSCBsFromPattern.maxFitsperTower= cms.int32(1100)
